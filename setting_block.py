...
class setting_block(Frame):
    ...
    def sb_makewidgets(self,parent=None):
        ...
        # Rows of the frame for drawing widgets (Ряды фрейма для отрисовки виджетов)
        row_1 = Frame(parent)
        row_2 = Frame(parent)
        ...
        # Whole set of widgets of the setting block (Весь набор виджетов блока настроек)
        ...
        # Drawing in 1st row of the frame (Отрисовка на 1-м ряду фрейма)
        ...
        # Drawing in 2nd row of the frame (Отрисовка на 2-м ряду фрейма)
        ...
        # Drawing in 3rd row of the frame (Отрисовка на 3-м ряду фрейма)
        ...
        # Drawing in 4th row of the frame (Отрисовка на 4-м ряду фрейма)
